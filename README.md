...
**Canvas App** is an app that allows users to use gestures in order to create fun pictures using a variety of images.
...
1. I think this is really cool and I'd love to see what other people did.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://raw.githubusercontent.com/marilymaril/canvasApp/master/canvasGif.gif title='Video Walkthrough' width='' alt='Video Walkthrough' />
